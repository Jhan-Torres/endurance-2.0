  ...
  <main class="container mx-auto px-4 py-8">
    ...
    <div v-if="loading" class="flex items-center justify-center py-12">
      ...
      <span class="ml-3 text-gray-600 dark:text-gray-400"
        >Loading personal information...</span
      >
    </div>
    ...
    >
      <div class="flex">
        <svg
          class="w-5 h-5 text-red-400 dark:text-red-300 mr-3 mt-0.5"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
    ...
    <div v-else-if="!hasPersonalInfo" class="text-center py-12">
      ...
      <p class="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
        Add your personal information to auto-fill forms on websites. This
        includes your name, contact details, and address.
      </p>
      <button
        @click="openCreateModal"
          ...
          <div>
            ...
            >
              ...
              <div v-if="personalInfo?.gender">
                ...
                <span class="ml-2 text-gray-900 dark:text-white capitalize">{{
                  personalInfo.gender.replace("-", " ")
                }}</span>
              </div>
          ...
          <div>
            ...
            <div v-if="personalInfo?.phoneNumbers.length" class="mb-4">
              ...
              <div class="space-y-1">
                ...
                >
                  <span
                    class="px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded text-xs uppercase"
                  >
                    {{ phone.type }}
                  </span>
                  <span class="text-gray-900 dark:text-white"
                    >{{ phone.countryCode }} {{ phone.number }}</span
                  >
                  <span
                    v-if="phone.isPrimary"
                    class="px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 rounded text-xs"
                  >
                    Primary
                  </span>
                </div>
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-blue-700 dark:text-blue-300 mt-1">
                  This information can be used to automatically fill forms on
                  websites, saving you time when filling out contact forms,
          ...
          <div class="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                Are you sure you want to delete your personal information? This
...
const handleLoadPersonalInfo = () => {
  loadPersonalInfo(); // Call without parameters
};
